...
import { AgentApp, Scenario } from "@holochain/tryorama";
import assert from "node:assert";
import { EmergenceClient } from "../ui/src/emergence-client.js";
import { EmergenceStore } from "../ui/src/emergence-store.js";

// store.setSessionInterest() as people are doing the sense-making game of saying what they are interested in.   So can you add a test where it simulates:
