...
import {
  ...
  type CellId,
  type EntryHash,
  type HoloHash} from '@holochain/client';
import type { AnyAgent, FeedElem, GetStuffInput, GetStuffOutput, Info, Note, ProxyAgent, Relation, RelationInfo, Session, Settings, SiteMap, Space, TagUse, TimeWindow, UpdateNoteInput, UpdateProxyAgentInput, UpdateSessionInput, UpdateSiteMapInput, UpdateSpaceInput } from './emergence/emergence/types';
