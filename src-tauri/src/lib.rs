...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            app.holochain()?
                .main_window_builder(String::from("main"), false, Some(String::from("emergence")), None)?
                .build()?;
...
fn holochain_dir() -> PathBuf {
    if tauri::is_dev() {
        let tmp_dir = tempdir::TempDir::new("emergence").expect("Could not create temporary directory");
